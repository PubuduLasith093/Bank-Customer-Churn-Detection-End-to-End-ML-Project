...
from bank_churn.cloud_storage.aws_storage import SimpleStorageService
from bank_churn.exception import BankChurnException
from bank_churn.logger import logging
from bank_churn.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.usvisa_estimator = bankchurnEstimator(bucket_name=model_pusher_config.bucket_name,
