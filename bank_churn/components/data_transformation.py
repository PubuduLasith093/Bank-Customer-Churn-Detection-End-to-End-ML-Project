...
from bank_churn.constants import TARGET_COLUMN, SCHEMA_FILE_PATH, CURRENT_YEAR
from bank_churn.entity.config_entity import DataTransformationConfig
from bank_churn.entity.artifact_entity import DataTransformationArtifact, DataIngestionArtifact, DataValidationArtifact
from bank_churn.exception import BankChurnException
from bank_churn.logger import logging
from bank_churn.utils.main_utils import save_object, save_numpy_array_data, read_yaml_file, drop_columns
#from bank_churn.entity.estimator import TargetValueMapping
    ...
    def initiate_data_transformation(self, ) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                target_feature_train_df = target_feature_train_df.to_list()
                ...
                target_feature_test_df = target_feature_test_df.to_list()
