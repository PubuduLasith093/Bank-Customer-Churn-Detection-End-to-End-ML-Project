...
from bank_churn.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from bank_churn.entity.config_entity import ModelTrainerConfig
from bank_churn.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            usvisa_model = BankChurnModel(preprocessing_object=preprocessing_obj,
